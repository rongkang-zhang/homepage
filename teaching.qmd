...
<ul class="horizontal-list">
    <li class="horizontal-list__item horizontal-list__item--orange">Statistics</li>
    <li class="horizontal-list__item horizontal-list__item--yellow">R</li>
    <li class="horizontal-list__item horizontal-list__item--blue">ML</li>
</ul>
